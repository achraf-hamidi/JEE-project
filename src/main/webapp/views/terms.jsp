...
<head>
	...
	<title>Terms & Conditions :: Learninggoods.com</title>
...
<h4>Introduction</h4>
THIS AGREEMENT BINDS YOU ("YOU") TO THE TERMS AND CONDITIONS SET FORTH HEREIN IN CONNECTION WITH YOUR USE OF www.learninggoods.com ("WE", "OUR", "US", OR "COMPANY") SOFTWARE, SERVICES OR OTHER OFFERINGS ON OUR SITE (COLLECTIVELY, OUR "PRODUCTS"). BY USING ANY OF THE COMPANY PRODUCTS, YOU AGREE TO ACCEPT THE TERMS AND CONDITIONS OF THIS AGREEMENT. IF YOU DO NOT ACCEPT THESE TERMS, YOU MUST NOT USE ALL OR ANY PORTION OF THE COMPANY PRODUCTS.
<br>
AS A USER OF THE WEBSITE, YOU MUST AGREE TO HAVE READ THE TERMS OF USING THE WEBSITE.
<br><br>
<h4>Privacy</h4>
Any personal information submitted in connection with your use of the products or the site is subject to our Privacy Policy, located at learninggoods.com
<br><br>
<h4>General</h4>
...
<br><br>
<h4>Connectivity and Equipment Costs</h4>
If you avail our services as an Instructor or a registered user, then you are solely responsible to bear any costs arising out of the equipment required for providing or accessing such services. You are solely responsible for all costs related to connectivity and data access, and/or other fees and costs associated with your access to and use of the Company Products, including, but not limited to, any data charges imposed by a wireless carrier or Internet Service Provider, and for obtaining and maintaining all telephone, computer hardware, and other equipment required for such access and use.
<br><br>
<h4>Payments and Tax</h4>
...
<br>
Please note that we don't store any of your bank account details related to your payments in our server. You understand that we are not accountable for any loss or damage caused due to the misuse or any negligence while transmitting such information.
<br><br>
<h4>Refunds</h4>
If you want to discontinue a course that you have enrolled in, then you can claim a full refund of your amount anytime after attending not more than two classes of a particular course by dropping a mail at contact@learninggoods.com. Please be informed that if it appears to us, at our discretion, that you are abusing our refund policy, then we reserve the right to suspend or terminate your account and block you from accessing any of our services in future, without any liability to you.
<br>
...
<br>
You are within your rights, unless you are an instructor, to terminate your use of our products and services at any time, either by not visiting our site, or by contacting us at contact@learninggoods.com. If you have registered with us as an instructor and have users enrolled in your course(s), then it becomes your obligation to complete all the stipulated sessions and notify us through email before terminating this agreement.
<br>
Note that in the event of an instructor receiving feedbacks consistently below the standards set by us, we hold the right to ask the particular instructor to stop conducting further classes on our website and terminate this agreement.
<br>
...
<br><br>
<h4>Miscellaneous</h4>
<b>Entire Agreement :</b> These terms and any policies applicable to you posted on the site constitute the entire agreement between the parties with respect to the subject matter hereof, and supersede all previous written or oral agreements between the parties with respect to such subject matter. These terms shall inure to our benefit and to the benefit of our agents, licensors, licensees, and successors.
<br>
<b>Sever ability :</b> If any provision of these terms is found to be illegal, void or unenforceable, then that provision shall be deemed severable from these terms and shall not affect the validity and enforceability of any remaining provisions of these terms.
<br>
<b>Waiver :</b> A provision of these terms may be waived only by a written instrument executed by the party entitled to the benefit of such provision. The failure of company to exercise or enforce any right or provision of these terms will not constitute a waiver of such right or provision.
<br>
<b>Notice :</b> Any notice or other communication to be given hereunder will be in writing and given by facsimile, postpaid registered or certified mail return receipt requested, or electronic mail.
<br>
